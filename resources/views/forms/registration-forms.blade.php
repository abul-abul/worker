...
<div class="choose-tabs">
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li role="as-who" class="active" id="tab_seeker"><a href="#seeker-tab" aria-controls="seeker-tab" role="tab" data-toggle="tab">as a Seeker <br> I'm looking for</a></li>
        <li role="as-who" id="tab_provider"><a href="#provider-tab" aria-controls="provider-tab" role="tab" data-toggle="tab">as a Provider <br> I can do</a></li>
    </ul>

    <!-- Tab panes -->
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="seeker-tab">
        ...
        <div role="tabpanel" class="tab-pane" id="provider-tab">
